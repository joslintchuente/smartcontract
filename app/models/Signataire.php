...
class Signataire
{
    ...
    {  // ok
        $this->id = $id;
        $this->db->query("SELECT NOM_COMPLET,EMAIL,TELEPHONE,PASSWORD FROM tblsignataire WHERE ID_SIGNATAIRE=$id");
    ...
    {  // ok
        ...
        var_dump($datef);
        $this->db->query("UPDATE tblhistoriquecontratssignataire SET STATUT='termine',DATEFIN='$datef' WHERE ID_CONTRAT=$id_contrat && ID_SIGNATAIRE=$this->id ");
    ...
    {   // ok
        ...
        $this->db->query("SELECT * FROM tblhistoriquecontratssignataire WHERE ID_SIGNATAIRE = $id");
    ...
    {  //  ok
        ...
        $this->db->query("SELECT STATUT FROM tblhistoriquecontratssignataire WHERE ID_CONTRAT=$id_contrat && ID_SIGNATAIRE=$this->id");
    ...
    public function create_commentaire($libelle, $type_acteur = "signataire", $id_personnel, $id_contrat)
    {
