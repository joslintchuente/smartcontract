                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form name="form" action="<?= URL_ROOT; ?>/redacteurs/enregistrermodif" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-2">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="projectname" class="form-control" disabled placeholder="type de Contrat" value="<?= $contrat->ID_TYPE_CONTRAT; ?>">
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" data-toggle="flatpicker" disabled placeholder="March 9, 2020" value="<?= $contrat->CREATION_DATE; ?>">
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="mb-3">
                                                <select class="form-control" data-toggle="select2" disabled data-width="100%">
                                            ...
                                            <div>
                                                ...
                                                <div class="mb-3 ">
                                                    <input type="text" id="project-budget" class="form-control" placeholder="Observations" disabled>
                                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <button name="enregistrermodif" type="submit" class="btn btn-success waves-effect waves-light m-1"><i class="fe-check-circle me-1"></i> Enregister les modifications</button>
