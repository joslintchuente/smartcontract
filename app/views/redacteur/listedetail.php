                    ...
                    <div class="card">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                ...
                                <button name="savemodifredacteur" type="submit" class="btn btn-success waves-effect waves-light m-1"><i class="fe-check-circle me-1"></i> Enregister les modifications</button>
                            </div>
                        </div>
                        <br>
                    <?php endforeach ?>
