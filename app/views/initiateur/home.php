                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Smart Contract</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboards</a></li>
                                <li class="breadcrumb-item active">Dashboard </li>
                            </ol>
                        </div>
                        <h4 class="page-title">Dashboard Initiateur </h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-0">Nouveau Contrat</h4>

                            <div id="cardCollpase1" class="collapse pt-3 show">
                                <div class="text-center">
                                    <div class="row mt-2">
                                        <div class="col-4">
                                            <h3 data-plugin="counterup">5</h3>
                                            <p class="text-muted font-13 mb-0 text-truncate">Contrats en Cours</p>
                                        </div>
                                        <div class="col-4">
                                            <h3 data-plugin="counterup">51</h3>
                                            <p class="text-muted font-13 mb-0 text-truncate">Evolutions</p>
                                        </div>
                                        <div class="col-4">
                                            <h3 data-plugin="counterup"></h3>
                                            <p class="text-muted font-13 mb-0 text-truncate">Pourcentages</p>
                                        </div>
                                    </div> <!-- end row -->
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-0">Contrats Terminés</h4>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-6">
                                            ...
                                            <p class="text-muted font-13 mb-0 text-truncate">Contrat Terminés</p>
                                        </div>
                                        <div class="col-6">
                                            <h3 data-plugin="counterup">1.52</h3>
                                            <p class="text-muted font-13 mb-0 text-truncate">Pourcentages</p>
                                        </div>
                                    </div> <!-- end row -->
                ...
                <div class="col-xl-4 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title mb-0">Contrats Annulés</h4>
                            ...
                            <div id="cardCollpase2" class="collapse pt-3 show">
                                <div class="text-center">
                                    <div class="row mt-2">
                                        <div class="col-4">
                                            <h3 data-plugin="counterup">3</h3>
                                            <p class="text-muted font-13 mb-0 text-truncate">Contrats Anulés</p>
                                        </div>
                                        <div class="col-4">
                                    ...
                                    <table class="table table-centered table-nowrap table-borderless mb-0">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th>Debut de contrat</th>
                                                <th>Date de création</th>
                                                <th>Niveau d'avancement</th>
                                                <th>Status</th>
                                                <th>Type Contrat</th>
                                                <th>
                                                    <button class="btn btn-success .round-pill">
                                                        <a href="<?= URL_ROOT; ?>/initiateurs/nouveau">Creer contrat</a>
                                                    </button>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <?php foreach ($data['contrats'] as $contrats) : ?>
                                                <tr>
                                                    ...
                                                    <td><?= $contrats->NIVEAU; ?></td>
                                                    <td><span class="badge bg-soft-info text-info p-1"><?= $data["statuts"][$i]; ?></span></td>
            ...
            <div class="tab-pane" id="chat-tab" role="tabpanel">
                ...
                <div class="p-2">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start noti-user-item">
                            <div class="position-relative me-2">
                                <img src="<?= URL_ROOT; ?>/public/assets/images/users/user-1.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                ...
                <div class="p-2 pb-4">
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start noti-user-item">
                            <div class="position-relative me-2">
                                <img src="<?= URL_ROOT; ?>/public/assets/images/users/user-2.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                                <i class="mdi mdi-circle user-status online"></i>
                            </div>
                            <div class="overflow-hidden">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start noti-user-item">
                            <div class="position-relative me-2">
                                <img src="<?= URL_ROOT; ?>/public/assets/images/users/user-4.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                                <i class="mdi mdi-circle user-status away"></i>
                            </div>
                            <div class="overflow-hidden">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start noti-user-item">
                            <div class="position-relative me-2">
                                <img src="<?= URL_ROOT; ?>/public/assets/images/users/user-5.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                                <i class="mdi mdi-circle user-status online"></i>
                            </div>
                            <div class="overflow-hidden">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start noti-user-item">
                            <div class="position-relative me-2">
                                <img src="<?= URL_ROOT; ?>/public/assets/images/users/user-6.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                                <i class="mdi mdi-circle user-status online"></i>
                            </div>
                            <div class="overflow-hidden">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start noti-user-item">
                            <div class="position-relative me-2">
                                <img src="<?= URL_ROOT; ?>/public/assets/images/users/user-7.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                                <i class="mdi mdi-circle user-status busy"></i>
                            </div>
                            <div class="overflow-hidden">
                    ...
                    <a href="javascript: void(0);" class="text-reset notification-item">
                        <div class="d-flex align-items-start noti-user-item">
                            <div class="position-relative me-2">
                                <img src="<?= URL_ROOT; ?>/public/assets/images/users/user-8.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                                <i class="mdi mdi-circle user-status away"></i>
                            </div>
                            <div class="overflow-hidden">
