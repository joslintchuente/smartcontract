                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Revue du Contrat</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Revue du Contrat</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= URL_ROOT; ?>/revues/enregistrermodifrevue" method="POST">
                                <?php foreach ($data as $contrat) : ?>
                                    <div class="row">
                                        <div class="col-xl-2">
                                            ...
                                            <div class="mb-3">
                                                <input type="hidden" name="idrevue" value="<?= $_SESSION['id_revue'] ?>">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <label for="terminecontrat">Termine le travail</label>
                                <input type="checkbox" name="terminecontrat">
                                <button name="savemodifrevue" type="submit" class="btn btn-success waves-effect waves-light m-1"><i class="fe-check-circle me-1"></i> Enregister les modifications</button>
