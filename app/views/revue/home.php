                                            ...
                                            <?php if (!empty($data['contrats'])) : ?>
                                                <?php foreach ($data['contrats'] as $contrats) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?= $data['instance']->get_niveau_statut($contrats->ID_CONTRAT); ?>
                                                        </td>
                                                        <td>
                                                            <form method="post" action="<?= URL_ROOT; ?>/revues/getContrats">
                                                                <input type="hidden" name="idcontrat" value="<?= $contrats->ID_CONTRAT; ?>">
                                                                <button type="submit" name="seecontractrevue" class="btn btn-primary">Editer le contrat</button>
                                                            </form>
                                                        </td>
