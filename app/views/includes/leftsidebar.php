                    ...
                    <div class="twocolumn-menu-item d-block" id="dashboard">
                        <div class="title-box">
                            ...
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="dashboard-4.html">Dashboard</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="sidebarProjects">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="project-list.html">Liste Des Contrats</a>
                                        </li>
                                        <li>
                                            <a href="project-detail.html">Details des Contrats</a>
                                        </li>
                                        <li>
                                            <a href="project-create.html">Nouveau Contrat</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                    ...
                    <div class="twocolumn-menu-item" id="uielements">
                        <div class="title-box">
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="ui-placeholders.html">Placeholders</a>
                                </li>
                                <li class="nav-item">
