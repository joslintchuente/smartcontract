                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form name="form" action="<?= URL_ROOT; ?>/fournisseurs/enregistrermodiffournisseur" method="POST">
                                <?php foreach ($data as $contrat) : ?>
                                    <div class="row">
                                        <div class="col-xl-2">
                                            ...
                                            <div class="mb-3">
                                                <input type="hidden" name="idfournisseur" value="<?= $_SESSION['id_fournisseur'] ?>">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <button name="savemodiffournisseur" type="submit" class="btn btn-success waves-effect waves-light m-1"><i class="fe-check-circle me-1"></i> J'accepte le contrat</button>
                            </div>
                        </div>
                        <br>
                    <?php endforeach ?>
